                ...
                if Area > 200.0:
                    ...
                    if color != "Blue":
                        ...
                        if ratio > 0.9:
                            ...
                            cls.arena[cx][cy] *= cls.interpretation_dict[triangle_dict[np.array((np.abs(np.array([x - Point_1[0], y - Point_2[1], x - Point_2[0],  y - Point_1[1]])) <= 5.0).nonzero()).T.reshape(-1)[0]]]
